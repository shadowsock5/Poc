### t3协议握手/通过t3协议查看weblogic版本/通过t3发送序列化数据
...
# Send headers
headers='t3 12.2.1\nAS:255\nHL:19\nMS:10000000\n\n'
headers_b = bytes.fromhex('74332031322e322e310a41533a3235350a484c3a31390a4d533a31303030303030300a0a')
print('sending "%s"' % headers)
sock.sendall(headers.encode())
#sock.sendall(headers_b)

data = sock.recv(1024)
print('received "%s"' % data)
print((re.findall(r'HELO:(.*?).false', data.decode()))[0])
...
实际效果参考：https://github.com/shadowsock5/Poc/blob/master/weblogic/log.md
